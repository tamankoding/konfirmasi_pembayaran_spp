            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Data Daftar Ulang Belum Dikonfirmasi</h3>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody id="pegawai">
                                                <?php
                                                $no = 1;
                                                $data = mysqli_query($mysqli, "SELECT * FROM daftar_ulang WHERE status='menunggu' ORDER BY id DESC");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="terima_du.php?id=<?= $d['id']; ?>" class="btn btn-success"><i class="fas fa-check"></i></a>
                                                            <a href="hapus_data_du_menunggu.php?id=<?= $d['id']; ?>" class="btn btn-danger" onclick="return confirm('yakin ingin menghapus data ?');"><i class="fas fa-trash-alt"></i></a>
                                                        </td>
