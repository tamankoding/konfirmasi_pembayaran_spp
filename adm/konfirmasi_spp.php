      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3>Data SPP Santri Terkonfirmasi</h3>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="card">
                  ...
                  <div class="table-responsive">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tbody id="pegawai">
                        <?php
                        $no = 1;
                        $data = mysqli_query($mysqli, "SELECT DISTINCT id, nama, tanggal_tf, nominal, keterangan FROM spp_santri WHERE status='diterima' ORDER BY id DESC");
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="hapus_data_spp_konfirmasi.php?id=<?= $d['id']; ?>" class="btn btn-danger" onclick="return confirm('yakin ingin menghapus data ?');"><i class="fas fa-trash-alt"></i></a>
                            </td>
