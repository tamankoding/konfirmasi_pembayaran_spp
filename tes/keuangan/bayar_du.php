...
$santri = query("SELECT * FROM daftar_ulang WHERE nama='$namasantri' ORDER BY id DESC");
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <div class="col-sm-12">
                            <h2 class="text-center">PEMBAYARAN DAFTAR ULANG <br><?= strtoupper($_SESSION['nama']);  ?></h2>
                        </div>
                        <div class="table-responsive">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody id="pegawai">
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($koneksi, "SELECT * FROM  daftar_ulang WHERE nama='$namasantri' ORDER BY id DESC");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?> <a href="keuangan/hapus_data_daftar_ulang.php?id=<?= $d['id']; ?>" class="btn btn-danger" onclick="return confirm('yakin ingin menghapus data ?');"><i class="fas fa-trash-alt"></i></a> <?php
                                                                                                                                                                                                                                        } else {
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-gray-dark">
                            <h3 class="modal-title" id="exampleModalLongTitle">Formulir Bayar Daftar Ulang</h3>
                        </div>
                            ...
                            <div class="container">
                                <form method="post" id="myform" autocomplete="off">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <h4>Angsuran Ke-</h4>
                                                <select class="custom-select" id="angsuran" name="angsuran">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="Tanggal Transfer" class="form-control" type="text" name="tanggal" onfocus="(this.type='date')" onblur="(this.type='text')" id="tanggal_tf" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    if (count($_POST) && (strpos($_POST['img'], 'data:image') === 0)) {
                                        ...
                                        $file = 'img/du-' . $namasantri . '-' . date("d-m-Y-His") . $ext;
                                        $name = 'du-' . $namasantri . '-' . date("d-m-Y-His") . $ext;

                                        if (file_put_contents($file, $data)) {
                                            $sql = "INSERT INTO daftar_ulang VALUES (DEFAULT, '$namasantri', '$sekolah', '$kelas', '$angsuran', '$tf', '$nominal', '$name', '$keterangan', 'menunggu')";
                                            ...
                                            if ($query) {
                                                echo "<script>
                                                        swal({
                                                            ...
                                                            window.location = 'media.php?p=daftarulang';
                                                        });
                                                    </script>";
                                            } else {
                                                echo "gagal";
                                    ...
                                    <script>
                                        function fileChange(e) {
                                            ...
                                            if (file.type == "image/jpeg" || file.type == "image/png") {
                                                ...
                                                alert('Silahkan pilih format gambar');
                                            }
                                        }
...
<script>
    $(document).ready(function() {
        $('.view_data').click(function() {
            var id = $(this).attr("id");
            $.ajax({
                url: "keuangan/view_bukti_du.php",
                method: "post",
                data: {
                    id: id
                },
